...
log_dir="/lustre/scratch126/humgen/projects/interval_rna/interval_rna_seq/thomasVDS/misexpression_v3/logs/star_fusion_max_sensitivity/${SAMPLE}"
mkdir -p $log_dir
#BSUB ARGUMENTS
...
bsub \
  ...
  -q $QUE \
  -J $SAMPLE \
  /software/singularity-v3.9.0/bin/singularity exec -B /lustre,/nfs $IMAGE $SCRIPT $SAMPLE