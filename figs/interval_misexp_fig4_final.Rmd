...
```{r}
readthrough_cov_misexp_zscore_pdf = file.path(fig4_out_dir, "del_dup_tx_readthrough_cov_misexp_zscore.pdf")
...
readthrough_fpkm_raw_path = file.path(supp_fig10_out_dir, "readthrough_fpkm_raw.pdf")
...
dev.off()
readthrough_fpkm_raw_png = file.path(supp_fig10_out_dir, "readthrough_fpkm_raw.png")
theme.fpkm_coverage_raw(readthrough_fpkm_raw)
...
readthrough_coverage_raw_path = file.path(supp_fig10_out_dir, "readthrough_fbnc_raw.pdf")
...
dev.off()
readthrough_coverage_raw_png = file.path(supp_fig10_out_dir, "readthrough_fbnc_raw.png")
theme.fpkm_coverage_raw(readthrough_coverage_raw)
...
tx_readthrough_del_dup_consq_path = file.path(supp_fig10_out_dir, "tx_readthrough_del_dup_consq.pdf")
...
dev.off()
tx_readthrough_del_dup_consq_png = file.path(supp_fig10_out_dir, "tx_readthrough_del_dup_consq.png")
theme.tx_readthrough_sv_types(tx_readthrough_vrnt_consq_fig)
...
otp_carrier_tpm_fig <- file.path(supp_fig10_out_dir, "otp_carrier_noncarrier.pdf")
...
dev.off()
otp_carrier_tpm_fig_png <- file.path(supp_fig10_out_dir, "otp_carrier_noncarrier.png")
theme.misexp_carrier_fig(otp_carrier_tpm_fig)
