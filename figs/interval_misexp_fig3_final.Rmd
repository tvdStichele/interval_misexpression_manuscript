...
misexp_sv_len_fig_singletons_path = file.path(supp_fig9_out_dir, "misexp_sv_len_singletons.pdf")
...
dev.off()
theme.misexp_svlen(misexp_sv_len_singletons)
misexp_sv_len_singletons_png <- file.path(supp_fig9_out_dir, "misexp_sv_len_singletons.png")
...
sv_cnsvtn_cnstrt_path <- file.path(wkdir, "5_misexp_vrnts/scores/results/misexp_sv_scores_enrich.tsv")
sv_cnsvtn_cnstrt_df <- read.csv(sv_cnsvtn_cnstrt_path, sep="\t")
sv_cnsvtn_cnstrt_df <- subset(sv_cnsvtn_cnstrt_df, region == "all")
...
sv_cnsvtn_cnstrt_no_len_adj_df <- subset(sv_cnsvtn_cnstrt_no_len_adj_df, region == "all")
...
sv_cnsvtn_cnstrt_no_len_adj_fig_path = file.path(supp_fig9_out_dir, "sv_cnsvtn_cnstrt_no_len_adj.pdf")
...
dev.off()
theme.sv_constr_consv(sv_constr_consv_no_len_adj_fig)
sv_cnsvtn_cnstrt_no_len_adj_fig_png <- file.path(supp_fig9_out_dir, "sv_cnsvtn_cnstrt_no_len_adj.png")
...
dup_del_all_reg_enrich_path = file.path(supp_fig9_out_dir, "dup_del_enrich_heatmap_all_no_len_adj.pdf")
pdf(dup_del_all_reg_enrich_path, width = 10,height = 4, useDingbats=FALSE)
feature_logr_mat_tp <- t(feature_logr_mat)
hm_sv_func_features <- Heatmap(feature_logr_mat_tp, 
              col= my_colors, # colormap 
