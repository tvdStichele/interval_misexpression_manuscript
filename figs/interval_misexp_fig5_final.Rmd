...
cphxl_carrier_tpm_fig <- file.path(supp_fig11_out_dir, "cphxl_carrier_noncarrier.pdf")
...
dev.off()
cphxl_carrier_tpm_fig_png <- file.path(supp_fig11_out_dir, "cphxl_carrier_noncarrier.png")
theme.misexp_carrier_fig(cphxl_carrier_tpm_fig)
...
carrier_tpm_fig <- file.path(supp_fig11_out_dir, "linc02308_carrier_noncarrier.pdf")
...
dev.off()
carrier_tpm_fig_png <- file.path(supp_fig11_out_dir, "linc02308_carrier_noncarrier.png")
theme.misexp_carrier_fig(carrier_tpm_fig)
...
carrier_tpm_fig <- file.path(supp_fig11_out_dir, "linc01097_carrier_noncarrier.pdf")
pdf(carrier_tpm_fig, width = 3, height = 4, useDingbats=FALSE)
...
theme.misexp_carrier_fig(carrier_tpm_fig)
dev.off()
carrier_tpm_fig_png <- file.path(supp_fig11_out_dir, "linc01097_carrier_noncarrier.png")
theme.misexp_carrier_fig(carrier_tpm_fig)
ggsave(carrier_tpm_fig_png, width=3, height=4, dpi=600)
```
...
carrier_tpm_fig <- file.path(supp_fig11_out_dir, "linc02268_carrier_noncarrier.pdf")
pdf(carrier_tpm_fig, width = 3, height = 4, useDingbats=FALSE)
...
theme.misexp_carrier_fig(carrier_tpm_fig)
dev.off()
carrier_tpm_fig_png <- file.path(supp_fig11_out_dir, "linc02268_carrier_noncarrier.png")
theme.misexp_carrier_fig(carrier_tpm_fig)
ggsave(carrier_tpm_fig_png, width=3, height=4, dpi=600)
```
...
carrier_tpm_fig <- file.path(supp_fig12_out_dir, "alpi_carrier_noncarrier.pdf")
pdf(carrier_tpm_fig, width = 3, height = 4, useDingbats=FALSE)
...
theme.misexp_carrier_fig(carrier_tpm_fig)
dev.off()
carrier_tpm_fig_png <- file.path(supp_fig12_out_dir, "alpi_carrier_noncarrier.png")
theme.misexp_carrier_fig(carrier_tpm_fig)
ggsave(carrier_tpm_fig_png, width=3, height=4, dpi=600)
```

### ROPN1B transcript proportions
```{r}
ropn1b_proport_tpm_path <- file.path(wkdir,"/6_misexp_dissect/other_mechanisms/605947_ENSG00000114547/ropn1b_proport_expression.tsv")
...
ropn1b_proport_tx_fig_pdf <- file.path(fig5_out_dir, "ropn1b_proport_tx.pdf")
pdf(ropn1b_proport_tx_fig_pdf, width = 6, height = 5, useDingbats=FALSE)
 
transcript_order <- c( 'ENST00000508088.1', 'ENST00000504401.1', "ENST00000513830.5", "ENST00000511082.1", 'ENST00000505382.5',
                       'ENST00000511035.5', 'ENST00000510450.1'
                      )
...
ropn1b_tx_proport_fig <- ggplot(ropn1b_proport_tpm_tx_subset_df, aes(y = rna_id, x =perc_expression , fill = transcript_id)) +
  ...
  scale_y_discrete(name = "Carriers") +
  scale_x_continuous(name = "Transcript percentage", 
                     breaks=c(0, 25, 50, 75, 100),
                     labels=c("0%", "25%", "50%", "75%", "100%"),
                     expand=c(0.001,0.001)) + 
  scale_fill_manual(name="", 
                    labels=transcript_order, 
                    values= c("ENST00000508088.1"="#DC267F", 
...
dev.off()
theme.misexp_tx_proport_fig(ropn1b_tx_proport_fig)
ropn1b_proport_tx_fig_png <- file.path(fig5_out_dir, "ropn1b_proport_tx.png")
ggsave(ropn1b_proport_tx_fig_png, width=5, height=4, dpi=600)
```
