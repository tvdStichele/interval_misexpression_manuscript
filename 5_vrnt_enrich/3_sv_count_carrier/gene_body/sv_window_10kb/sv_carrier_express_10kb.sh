#!/bin/bash
#BSUB -o /lustre/scratch126/humgen/projects/interval_rna/interval_rna_seq/thomasVDS/misexpression_v3/logs/sv_carrier_count_gene_body_10kb/carrier_info_chr%I.out
#BSUB -e /lustre/scratch126/humgen/projects/interval_rna/interval_rna_seq/thomasVDS/misexpression_v3/logs/sv_carrier_count_gene_body_10kb/carrier_info_chr%I.out
#BSUB -q "normal"
